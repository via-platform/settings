...
export default class AccountsPanel {
    constructor(settingsView, packageManager){
        ...
        this.disposables.add(via.accounts.onDidActivateAccount(this.loadAccounts.bind(this)));
        this.disposables.add(via.accounts.onDidDeactivateAccount(this.loadAccounts.bind(this)));
        this.disposables.add(via.accounts.onDidAddAccount(this.loadAccounts.bind(this)));
        this.disposables.add(via.accounts.onDidRemoveAccount(this.loadAccounts.bind(this)));
                ...
                <div className='section'>
                    <div className='section-container'>
                        ...
                        <div className='accounts-panel-options'>
                            ...
                            <button type='button' className='btn add-account-button' onclick={() => this.addAccount()}>Add Trading Account</button>
                        </div>
                        <section className='sub-section'>
                            <h3 className='sub-section-heading'>
                                Linked Accounts
                            </h3>
                            <div ref="accounts" className='container accounts-container'>
    ...
    loadAccounts(){
        const accounts = via.accounts.getAccounts();
