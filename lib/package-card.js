    ...
    return (
        <div className='package-card'>
            ...
            <div ref='updateButtonGroup' className='btn-group'>
                <button type='button' className='btn btn-info install-button' ref='updateButton'>Update</button>
            </div>
            <div ref='installAlternativeButtonGroup' className='btn-group'>
                <button type='button' className='btn btn-info install-button' ref='installAlternativeButton'>Install Alternative</button>
            </div>
            <div ref='installButtonGroup' className='btn-group'>
                <button type='button' className='btn btn-info install-button' ref='installButton'>Install Package</button>
            </div>
