...
import ExchangesPanel from './exchanges-panel'
...
module.exports = class SettingsView {
      ...
      <div className='settings-view pane-item' tabIndex='-1'>
        ...
        <div className='settings-panels'>
            <div className='settings-menu' ref='menu'>
              <ul className='panels-menu nav nav-tabs' ref='panelMenu'>
  ...
  initializePanels () {
    ...
    this.addCorePanel('Exchanges', 'exchanges', () => new ExchangesPanel())
    this.addCorePanel('Accounts', 'accounts', () => new AccountsPanel(this, this.packageManager))
    ...
    this.addCorePanel('Manage Packages', 'package', () => new InstalledPackagesPanel(this, this.packageManager))
    ...
    this.addCorePanel('Install Packages', 'plus', () => new InstallPanel(this, this.packageManager))
