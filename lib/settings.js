...
module.exports = class Settings {
    ...
    destroy() {
        ...
        for(let panel of this.panelsByName){
            panel.destroy();
        }
    ...
    render(){
        return (
            <div className='settings' tabIndex='-1'>
                <div className='settings-menu' ref='toolbar'>
                    <ul className='panels-menu nav nav-tabs' ref='menu'>
    ...
    initializePanels() {
        ...
        const focusHandler = () => this.focusActivePanel();
        ...
        this.addCorePanel('Core', () => new GeneralPanel());
    ...
    getPackages() {
        ...
        for (const packageName of disabledPackages) {
            ...
            if (!_.findWhere(this.packages, {
                ...
                this.packages.push({
                    name, metadata, path: packagePath
                })
            }
        }
