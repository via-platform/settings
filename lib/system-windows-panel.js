...
import {WinShell, CompositeDisposable} from 'via'
        ...
        <form className='general-panel section'>
          <div className='settings-panel'>
            <div className='section-container'>
              ...
              <div className='text icon icon-question'>These settings determine how Via integrates with your operating system.</div>
